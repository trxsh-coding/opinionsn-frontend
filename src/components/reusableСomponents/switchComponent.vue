<template>
	<div class="switch-block flex-align-center mt-12 pointer" @click="change" :style="wrapperPosition">
		<div class="switch-button mr-6" :style="wrapperStyle" v-if="type === 'button'">
	...
	export default {
		...
		computed: {
			...
			circleStyle() {
				...
				let position = boolean ? {transform: 'translateX(100%)'} : {transform: 'translateX(0)'};
