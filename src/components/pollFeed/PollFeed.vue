		...
		data() {
			return {
				...
				tournamentInfo: [
					...
					{place:'7-10', id:1939, accuracy:41, result:12, username:'fanrodman',},
					{place:'7-10', id:2377, accuracy:41, result:12, username:'almameter'},
					{place:'7-10', id:2376, accuracy:51, result:15, username:'Politotosha',},
					{place:'11', id:7, accuracy:37, result:11, username:'Elealirina',},
					{place:'12', id:4605, accuracy:34, result:10, username:'Oloir',},
					{place:'13', id:6235, accuracy:31, result:9, username:'Asidie',},
