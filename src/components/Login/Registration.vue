<template lang="html">
	<div class="register-section">
		...
		<div class="buttons-block mt-23">
			...
			<button-reusable
					@click.native="loading ? check() : submit(registrationForm)"
...
<script>
	...
	export default {
		...
		computed: {
			...
			queryList() {
				let {refer, categoryId, redirectToPoll, inviter_id} = this.$route.query;

				let query = {refer, categoryId, redirectToPoll, inviter_id};
