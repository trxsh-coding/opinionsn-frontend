	...
	<div class="poll-preview">
		...
		<div class="main-block">
			...
			<div class="options-block" v-if="!mobile" @click="pollLink(poll.id)">
				<div class="options"
					 v-for="{option, isSelected} in sanitizedOptions[0].option.picture != null ? sanitizedOptions.slice(0, 2) : sanitizedOptions">

					<div class="option">
						<div class="picture-with-options" :class="{'is-voted' : isSelected}"
							 :style="{ 'background-image': 'url(' + publicPath + option.picture + ')' } "
							 v-if="option.picture">
						</div>
						<div class="text-block flex-align-center"
							 :class="{'picture-option' : option.picture, 'main-option' : isSelected} ">
