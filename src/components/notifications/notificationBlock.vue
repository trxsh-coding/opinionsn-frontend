<template>
	<div class="notification-block flex-column">
		<div class="notification-header flex-align-center mb-6">
			...
			<div class="notification-new-user flex-align-center"
				 v-if="notification.eventType === 'APPOINTMENT_OF_JUDGES' || notification.eventType === 'BLOCKCHAIN_PREDICTION_FINISHED' || notification.eventType === 'BLOCKCHAIN_PREDICTION_WINNER'">
				<icon-base
					class="mr-10"
					width="24"
					height="24"
