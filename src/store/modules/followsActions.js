...
export const followsActions = sc => class extends sc {
    ...
    followUser({commit, dispatch}, payload={}){
        ...
        let {customUrl = `${process.env.VUE_APP_MAIN_API}/api/rest/follow/${id}`, data={id}, method='post', } = payload;
    ...
    unFollowUser({commit, dispatch}, payload={}){
        ...
        let {customUrl = `${process.env.VUE_APP_MAIN_API}/api/rest/unFollow/${id}`, data={id}, method='post', } = payload;
    ...
    getFollowings({commit, dispatch}, payload={}){
        ...
        let {customUrl = `${process.env.VUE_APP_MAIN_API}/api/rest/getFollowing`, data={}, method='get', } = payload;
    ...
    getFollowers({commit, dispatch}, payload={}){
        ...
        let {customUrl = `${process.env.VUE_APP_MAIN_API}/api/rest/getMyFollowers`, data={}, method='get', } = payload;
    ...
    getMyFollowings({commit, dispatch}, payload={}){
        ...
        let {customUrl = `${process.env.VUE_APP_MAIN_API}/api/rest/vote/feed/leaders`, data={}, method='get', } = payload;
